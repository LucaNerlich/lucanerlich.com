...
the [box model](../css/beginners-guide/03-the-box-model.mdx),
[colors and typography](../css/beginners-guide/04-colors-and-typography.md), and
[Flexbox](../css/beginners-guide/07-flexbox.mdx) chapters back up what happens in the header and cards below.
...
- **`repeat(auto-fit, minmax(18rem, 1fr))`**. This is the whole responsive layout. "Fit as many 18rem-wide columns as
  ...
  get two. The [CSS Grid chapter](../css/beginners-guide/08-css-grid.mdx) covers `auto-fit` vs `auto-fill` and why this
...
[The DOM](../javascript/beginners-guide/08-the-dom.mdx) and [Events](../javascript/beginners-guide/09-events.mdx).
...
| Relative dates| `Intl.RelativeTimeFormat` - the browser's built-in human-readable dates. See [Intl API Formatting](../javascript/javascript-intl-api-formatting.mdx) for the sibling APIs (numbers, currency, full dates). |
...
[Async/Await Patterns](../javascript/async-await-guide.mdx) for the Promise behaviour behind `await`.
...
- [CSS Beginners' Guide](../css/beginners-guide/01-introduction.md) - go deeper on selectors, the box model, Grid, and
  Flexbox. The chapters on [CSS Grid](../css/beginners-guide/08-css-grid.mdx),
...
- [JavaScript Beginners' Guide](../javascript/beginners-guide/01-introduction.md) - 15 chapters from `console.log` to
  deploying a site on a VPS. [The DOM](../javascript/beginners-guide/08-the-dom.mdx),
  [Events](../javascript/beginners-guide/09-events.mdx), and
  [Working with Data](../javascript/beginners-guide/10-working-with-data.md) cover everything `app.js` and `posts.json`
  touch.
- [Intl API Formatting](../javascript/javascript-intl-api-formatting.mdx) - deeper dive on the `Intl` family we used for
  relative dates.
