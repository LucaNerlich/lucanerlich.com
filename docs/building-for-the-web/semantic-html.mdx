...
Several HTML elements on this page — `<dialog>`, `<details>`, `<popover>` — have uneven browser support. Add the [MDN MCP server](../ai/mdn-mcp-server.md) to your IDE or Claude Code and ask "what is the browser support for `<dialog>`?" to get a live compatibility table straight from MDN.
:::
