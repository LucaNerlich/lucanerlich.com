...
| **SEO** | Search engines use semantic structure to understand page content. `<article>`, headings, and `<time>` make that structure easier to interpret. |
...
- **Prefer one primary `<h1>` per page** - it usually represents the page title
- **Do not skip levels without a reason** - go from `<h2>` to `<h3>` when the content is truly nested
- **Use headings for structure, not styling** - if you need larger text, use CSS
- **Give sections an accessible label** - usually a visible heading, occasionally `aria-label`/`aria-labelledby`
...
<div style={{padding: '1.5rem', border: '2px dashed var(--ifm-color-emphasis-300)', borderRadius: '8px', marginBottom: '1.5rem'}}>
...
<div style={{padding: '1.5rem', border: '2px dashed var(--ifm-color-emphasis-300)', borderRadius: '8px', marginBottom: '1.5rem'}}>
<strong>Rendered examples:</strong>

<p><strong>Warning:</strong> this will delete all data.</p>
<p>You <em>must</em> restart the server.</p>
<p>Search results for <mark>semantic</mark> HTML.</p>
<p>Price: <del>$49</del> <ins>$29</ins></p>
<p><abbr title="Hypertext Markup Language">HTML</abbr> is the standard markup language.</p>
<p>Read <cite>The Pragmatic Programmer</cite> by Hunt and Thomas.</p>
<p>Published on <time dateTime="2025-03-15">15 March 2025</time>.</p>
<p>Press <kbd>Ctrl</kbd>+<kbd>S</kbd> to save.</p>
<p>The console prints <samp>Hello, world!</samp></p>
<p>Let <var>x</var> be the number of users.</p>
<p><small>Terms and conditions apply.</small></p>
<p>H<sub>2</sub>O &nbsp;&nbsp; E = mc<sup>2</sup></p>
<p>She said <q>it works on my machine</q>.</p>
<p>A <dfn>CDN</dfn> is a content delivery network.</p>
</div>
...
<form onSubmit={(e) => e.preventDefault()}>
    <fieldset>
        ...
        <div style={{marginBottom: '0.75rem'}}>
            <label htmlFor="demo-email" style={{display: 'block', marginBottom: '0.25rem'}}>Email address</label>
            <input type="email" id="demo-email" placeholder="you@example.com" style={{padding: '0.4rem 0.6rem', borderRadius: '4px', border: '1px solid var(--ifm-color-emphasis-300)', width: '100%', maxWidth: '320px'}} />
        </div>
        <div style={{marginBottom: '0.75rem'}}>
            <label htmlFor="demo-name" style={{display: 'block', marginBottom: '0.25rem'}}>Full name</label>
            <input type="text" id="demo-name" style={{padding: '0.4rem 0.6rem', borderRadius: '4px', border: '1px solid var(--ifm-color-emphasis-300)', width: '100%', maxWidth: '320px'}} />
        </div>
        <button type="submit" style={{padding: '0.4rem 1rem', borderRadius: '4px', cursor: 'pointer'}}>Subscribe</button>
    </fieldset>
</form>
</div>
...
<div style={{padding: '1.5rem', border: '2px dashed var(--ifm-color-emphasis-300)', borderRadius: '8px', marginBottom: '1.5rem'}}>
<strong>Rendered - native input types:</strong>

<div style={{display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(220px, 1fr))', gap: '0.75rem', marginTop: '0.75rem'}}>
<div>
    <label htmlFor="demo-text" style={{display: 'block', fontSize: '0.85rem', marginBottom: '0.2rem'}}>text</label>
    <input type="text" id="demo-text" placeholder="Text input" style={{width: '100%', padding: '0.3rem 0.5rem', borderRadius: '4px', border: '1px solid var(--ifm-color-emphasis-300)'}} />
</div>
<div>
    <label htmlFor="demo-email2" style={{display: 'block', fontSize: '0.85rem', marginBottom: '0.2rem'}}>email</label>
    <input type="email" id="demo-email2" placeholder="you@example.com" style={{width: '100%', padding: '0.3rem 0.5rem', borderRadius: '4px', border: '1px solid var(--ifm-color-emphasis-300)'}} />
</div>
<div>
    <label htmlFor="demo-number" style={{display: 'block', fontSize: '0.85rem', marginBottom: '0.2rem'}}>number</label>
    <input type="number" id="demo-number" placeholder="42" style={{width: '100%', padding: '0.3rem 0.5rem', borderRadius: '4px', border: '1px solid var(--ifm-color-emphasis-300)'}} />
</div>
<div>
    <label htmlFor="demo-date" style={{display: 'block', fontSize: '0.85rem', marginBottom: '0.2rem'}}>date</label>
    <input type="date" id="demo-date" style={{width: '100%', padding: '0.3rem 0.5rem', borderRadius: '4px', border: '1px solid var(--ifm-color-emphasis-300)'}} />
</div>
<div>
    <label htmlFor="demo-time" style={{display: 'block', fontSize: '0.85rem', marginBottom: '0.2rem'}}>time</label>
    <input type="time" id="demo-time" style={{width: '100%', padding: '0.3rem 0.5rem', borderRadius: '4px', border: '1px solid var(--ifm-color-emphasis-300)'}} />
</div>
<div>
    <label htmlFor="demo-color" style={{display: 'block', fontSize: '0.85rem', marginBottom: '0.2rem'}}>color</label>
    <input type="color" id="demo-color" defaultValue="#3578e5" style={{width: '100%', height: '34px', borderRadius: '4px', border: '1px solid var(--ifm-color-emphasis-300)', cursor: 'pointer'}} />
</div>
<div>
    <label htmlFor="demo-range" style={{display: 'block', fontSize: '0.85rem', marginBottom: '0.2rem'}}>range</label>
    <input type="range" id="demo-range" min="0" max="100" defaultValue="50" style={{width: '100%'}} />
</div>
<div>
    <label htmlFor="demo-search" style={{display: 'block', fontSize: '0.85rem', marginBottom: '0.2rem'}}>search</label>
    <input type="search" id="demo-search" placeholder="Search..." style={{width: '100%', padding: '0.3rem 0.5rem', borderRadius: '4px', border: '1px solid var(--ifm-color-emphasis-300)'}} />
</div>
<div>
    <label style={{display: 'block', fontSize: '0.85rem', marginBottom: '0.2rem'}}>checkbox</label>
    <label><input type="checkbox" defaultChecked /> Remember me</label>
</div>
<div>
    <label style={{display: 'block', fontSize: '0.85rem', marginBottom: '0.2rem'}}>radio</label>
...
<div>
<label htmlFor="demo-country" style={{display: 'block', marginBottom: '0.25rem'}}>Country</label>
<select id="demo-country" style={{padding: '0.4rem 0.6rem', borderRadius: '4px', border: '1px solid var(--ifm-color-emphasis-300)'}}>
    <option value="">- Select -</option>
    <optgroup label="Europe">
        <option value="de">Germany</option>
        <option value="fr">France</option>
...
<div style={{marginBottom: '0.75rem'}}>
<label htmlFor="demo-progress" style={{marginRight: '0.5rem'}}>Upload progress:</label>
<progress id="demo-progress" value="70" max="100">70%</progress>
</div>
<div>
<label htmlFor="demo-meter" style={{marginRight: '0.5rem'}}>Disk usage:</label>
<meter id="demo-meter" value="0.7" min="0" max="1" low="0.3" high="0.8" optimum="0.1">70%</meter>
</div>
</div>
...
<div style={{padding: '1.5rem', border: '2px dashed var(--ifm-color-emphasis-300)', borderRadius: '8px', marginBottom: '1.5rem'}}>
<strong>Rendered (click to toggle):</strong>
...
See the [Web Performance - Images](./web-performance.md#images) section for responsive image patterns with `srcset` and `sizes`.
...
<address>
    <span style={{color: 'var(--ifm-link-color)', textDecoration: 'underline'}}>luca.nerlich@gmail.com</span><br />
    <span style={{color: 'var(--ifm-link-color)', textDecoration: 'underline'}}>GitHub</span>
</address>
</div>

Use `<address>` for contact information tied to the current page or article. A plain postal address with no contact context can stay a normal paragraph.
...
A placeholder inside a Web Component's shadow DOM that receives content from the light DOM. See the [JavaScript: Web Components](../javascript/beginners-guide/11-project-build-a-website.md#web-components) section for details.
...
:::tip[Check browser support without leaving your editor]
Several HTML elements on this page -- especially `<dialog>` and the newer platform APIs around popovers -- have uneven browser support. Add the [MDN MCP server](../ai/mdn-mcp-server.md) to your IDE or Claude Code and ask "what is the browser support for `<dialog>`?" to get a live compatibility table straight from MDN.
:::
