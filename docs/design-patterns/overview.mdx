...
Before reaching for a pattern, prefer the simplest language or library feature that already solves the problem. Patterns help when the design forces are real and worth naming.
...
- Review [Anti-Patterns and Misuse](./anti-patterns.mdx) when a pattern feels like ceremony.
- Use the [Glossary](./glossary.mdx) if a term is unfamiliar.
