...
| [Development](./development.mdx) | Project bootstrap, `aem-cli`, `fstab.yaml`, `paths.json`, GitHub flow |
| [Sidekick](./sidekick.mdx) | Sidekick browser extension + the Sidekick Library plugin model |
| [Admin API (helix5)](./admin-api.mdx) | `admin.hlx.page` reference - auth, endpoints, Configuration Service, workflows |
| [Experimentation](./experimentation.mdx) | Experiment variants, page metadata, RUM measurement |
...
third-party commerce backends. Catalog page shells are rendered and cached at the edge, while
cart, checkout, and other transactional state live in the browser against the commerce API.
See [Commerce](./commerce.mdx).
...
| **Personalisation** | Target / ContextHub | Experimentation plugin / decisioning integrations |
...
- [Edge Delivery Services overview](https://experienceleague.adobe.com/en/docs/experience-manager-cloud-service/content/edge-delivery/overview) - Adobe documentation
