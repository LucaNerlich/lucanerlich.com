...
- [Adobe: Administering Workflows](https://experienceleague.adobe.com/en/docs/experience-manager-65/administering/operations/workflows.html)
- [Adobe: Developing and Extending Workflows](https://experienceleague.adobe.com/en/docs/experience-manager-65/developing/extending-aem/extending-workflows/workflows.html)
- [Adobe: Asset Microservices (AEMaaCS)](https://experienceleague.adobe.com/en/docs/experience-manager-cloud-service/content/assets/manage/asset-microservices-configure-and-use.html)
