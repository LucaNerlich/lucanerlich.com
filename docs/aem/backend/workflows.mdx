...
In the OR Split, set each branch's routing expression type to **Script**, with the language set
to **ECMA Script**, and paste the function into the inline script field:
