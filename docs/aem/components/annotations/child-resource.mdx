...
component resource node (which itself usually lives somewhere below the page's `jcr:content`). `@ChildResource`
tells Sling Models to look for those child nodes and adapt
...
- [Sling Models Available Injectors](https://sling.apache.org/documentation/bundles/models.html#available-injectors) - full list of injectors including `@ChildResource`
- [Sling Models API Javadoc](https://javadoc.io/doc/org.apache.sling/org.apache.sling.models.api/latest/index.html) - `@ChildResource` annotation javadoc
