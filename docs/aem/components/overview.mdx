...
| `getAppliedStyles()` | The list of `StyleInfo` objects currently applied to the component |
| `getAppliedHtmlElement()` | The HTML element name selected via the Style System (if configured) |
