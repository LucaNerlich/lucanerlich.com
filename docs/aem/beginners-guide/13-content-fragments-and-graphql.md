...
Next up: [Search & Indexing](./14-search-and-indexing.md) - querying content efficiently with
QueryBuilder and JCR-SQL2, and defining the Oak indexes that keep those queries fast.
