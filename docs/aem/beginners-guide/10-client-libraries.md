...
- [@aemvite: Migrate ui.frontend from Webpack to Vite](../aemvite.mdx) - replace webpack + `aem-clientlib-generator` with Vite + esbuild while keeping clientlib descriptors byte-identical
