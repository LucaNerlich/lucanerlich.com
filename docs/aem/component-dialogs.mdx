...
1. Open the [CRXDE](https://experienceleague.adobe.com/en/docs/experience-manager-65/developing/devtools/developing-with-crxde-lite.html?lang=en) [http://localhost:4502/crx/de/index.jsp](http://localhost:4502/crx/de/index.jsp) console.
...
- [Configuring the Rich Text Editor (Experience League)](https://experienceleague.adobe.com/en/docs/experience-manager-cloud-service/content/implementing/developing/full-stack/rich-text-editor)
...
See also the [Tags and Taxonomies](./content/tags-taxonomies.md) deep dive and Adobe's
[Administering Tags](https://experienceleague.adobe.com/en/docs/experience-manager-cloud-service/content/sites/administering/site-and-page-features/tags) documentation.
...
[Configuring the Rich Text Editor](https://experienceleague.adobe.com/en/docs/experience-manager-cloud-service/content/implementing/developing/full-stack/rich-text-editor)
guide and the
[RichText Granite UI reference](https://developer.adobe.com/experience-manager/reference-materials/6-5/granite-ui/api/jcr_root/libs/cq/gui/components/authoring/dialog/richtext/index.html).
