...
| **Granite UI server-side docs** | `http://localhost:4502/libs/granite/ui/components/coral/foundation/server.html` |
...
Button variants: `default`, `primary`, `warning`, `quiet`, `minimal`, `quietaction`, `action`
