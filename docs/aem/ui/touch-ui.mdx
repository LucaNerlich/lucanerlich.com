...
Note, that the [Sling Resource Merger](https://experienceleague.adobe.com/en/docs/experience-manager-65/developing/platform/sling-resource-merger.html?lang=en) pulls in additional nodes from the parents Text Core Component dialog.
