...
description: A Java tool that parses Discord chat export JSON files and generates ranked statistics — message count, mentions, reactions, attachments, and account age.
