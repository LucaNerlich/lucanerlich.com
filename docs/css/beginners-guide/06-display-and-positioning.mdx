...
import PositionDemo from '@site/src/components/demos/css/PositionDemo';
...
Scroll the frame and switch `position` values. Sticky sticks inside the scroll parent; absolute leaves normal flow:
